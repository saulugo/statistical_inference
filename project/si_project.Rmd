...
- As it is shown in the previous R chunk, the mean of these **`r n`** exponentials is **`r mean_y`**

Also, the teorethical standard deviation of the exponential distribution is equal to 1/lambda:

- As it is shown in the previous R chunk, the standard deviation of these **`r n`** exponentials is **`r sd_y`**
